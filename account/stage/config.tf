...
module "sns" {
  environment                             = "${var.environment}"
  aws_account_id                          = "${var.aws_account_id}"
  ch-status-check_lambda_arn         = "${var.ch-status-check_lambda_arn}"
  ch_form_submission_lambda_arn      = "${var.ch_form_submission_lambda_arn}"
  fallback_queue_arn                 = "${module.sqs.fallback_queue_arn}"
  ch_get_document_lambda_arn         = "${var.ch_get_document_lambda_arn}"
  ch_status_notify_lambda_arn        = "${var.ch_status_notify_lambda_arn}"
  cp_submit_application_lambda_arn   = "${var.cp_submit_application_lambda_arn}"
  dlq_queue_arn                      = "${module.sqs.dlq_queue_arn}"
  id_check_credits_verify_queue_arn  = "${var.id_check_credits_verify_queue_arn}"
...
module "cloudwatch" {
  ...
  ch_form_submission_lambda_name = "${var.ch_form_submission_lambda_arn}"
